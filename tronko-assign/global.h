...
#define _GLOBAL_
#define STATESPACE                                                             \
    20 /*number of categories in approximation of gamma distribution for Ne.   \
          Must be at least 4 because some of the memory is used for the        \
          nucleotide model*/
#define MAXNUMBEROFINDINSPECIES                                                \
    500 /*maximum number of individuals belonging to a species*/
#define MAXQUERYLENGTH 30000
#define MAX_CIGAR 100
#define NUMCAT                                                                 \
    1 /*number of categories in the discretization of the gamma for the        \
         nucleotide substituion model*/
...
// extern int numspec, numbase, root/*, **seq,
// numundspec[MAXNUMBEROFINDINSPECIES+1]*/;
...
// extern double LRVEC[STATESPACE][STATESPACE], RRVEC[STATESPACE][STATESPACE],
// RRVAL[STATESPACE], PMAT1[STATESPACE][STATESPACE],
// PMAT2[STATESPACE][STATESPACE]; extern double LRVECnc[4][4], RRVECnc[4][4],
// RRVALnc[4], PMATnc[2][4][5]; extern double *statevector, UFC, *UFCnc,
// **templike_nc; extern int ***PP; // WE SHOULD TEST WHAT IS THE FASTEST. MAYBE
// MOVE TO UNSIGNED SHORT? extern type_of_PP ***PP; extern type_of_PP ***PPcopy;
