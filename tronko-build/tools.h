...
int DiscreteGamma(double freqK[], double rK[], double alfa, double beta, int K,
                  int median);
double PointChi2(double prob, double v);
#define PointGamma(prob, alpha, beta)                                          \
    PointChi2(prob, 2.0 * (alpha)) / (2.0 * (beta))
#define CDFGamma(x, alpha, beta)                                               \
    IncompleteGamma((beta) * (x), alpha, LnGamma(alpha))
...
int RemoveIndel(char *z[], int *ns, int *ls, int posit[], int n31,
                int concensus);
int f_mono_di(FILE *fout, char z[], int ls, int iring, double fb1[],
              double fb2[], double CondP[]);
int PickExtreme(FILE *fout, char z[], int ls, int iring, int lfrag,
                int ffrag[]);
...
int symtest(double freq[], int n, int nobs, double space[], double *chisym,
            double *chihom);
int ng1986_1(char z1[], char z2[], int lc, int code, int transfed, double *Ks,
             double *Ka, double *S, double *N);
...
int EvolveHKY85(char source[], char target[], int ls, double t, double rates[],
                double pi[6], double kapa, int isHKY85);
int DistanceMatNuc(FILE *fout, int model, double alfa, double *kapa);
int EigenREV(FILE *fout, double kapa[], double pi[], int *nR, double Root[],
             double Cijk[]);
...
int eigen(int job, double A[], int n, double rr[], double ri[], double vr[],
          double vi[], double w[]);

int MeanVar(double x[], int n, double *mean, double *var);
int variance(double x[], int n, int nx, double mx[], double vx[]);
int correl(double x[], double y[], int n, double *mx, double *my, double *v11,
           double *v12, double *v22, double *r);
...
complex comple(double re, double im);
...
int EigenUNREST(FILE *fout, double kapa[], double pi[], int *nR,
                complex cRoot[], complex cU[], complex cV[]);
int cPMat(double P[], double t, int n, complex cU[], complex cV[],
          complex cRoot[]);
...
int H_end(double x0[], double x1[], double f0, double f1, double e1, double e2,
          int n);
double LineSearch2(double (*fun)(double x[], int n), double *f, double x0[],
                   double p[], double h, double limit, double e, double space[],
                   int n);

int ming2(FILE *fout, double *f, double (*fun)(double x[], int n),
          int (*dfun)(double x[], double *f, double dx[], int n), double x[],
          double xb[][2], double space[], double e, int n);

int ming1(FILE *fout, double *f, double (*fun)(double x[], int n),
          int (*dfun)(double x[], double *f, double dx[], int n),
          int (*testx)(double x[], int n), double x0[], double space[],
          double e, int n);

int Newton(FILE *fout, double *f, double (*fun)(double x[], int n),
           int (*ddfun)(double x[], double *fx, double dx[], double ddx[],
                        int n),
           int (*testx)(double x[], int n), double x0[], double space[],
           double e, int n);
...
int nls2(FILE *fout, double *sx, double *x0, int nx,
         ...
         int (*testx)(double x[], int nx), int ny, double e1, double e2);
...
int RootTN93(int ischeme, double kapa1, double kapa2, double pi[], double *f,
             double Root[]);
int EigenTN93(int ischeme, double kapa1, double kapa2, double pi[6], int *nR,
